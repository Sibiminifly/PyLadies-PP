...
class Dog(Pet):
    def make_sound(self):
        return super().make_sound() + "Woof woof!".format(name=self.name,)


class Cat(Pet):
    def make_sound(self):
        return super().make_sound() + "Meow!".format(name=self.name,)
...
class CyfrowyBudzik(Budzik):
    pass

class AnalogowyBudzik(Budzik):
    def budz(self):
        return 'Trrrr!'

class MagicznyBudzik(Budzik):
    def budz(self):
        return super().budz() + 'Kukuryyku!'

class DziwnyBudzik(Budzik):
    def budz(self):
        return ''

class DnirobiczyBudzik(Budzik):
    def budz(self):
